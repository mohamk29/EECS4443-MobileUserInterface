...
public class DemoTiltBall46880Activity extends Activity implements SensorEventListener
{
    ...
    /**
     * variable to store: numberOFLaps
     */
    int gain, numberOfLaps;
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        /**
         * Connected a sound file through MediaPlayer (to make sound for a completed lap)
         */
