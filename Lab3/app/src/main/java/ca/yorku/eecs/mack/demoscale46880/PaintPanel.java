...
public class PaintPanel extends View
{
    ...
    /**
     Declare the zoomIn variable (switch to determine the back and forth between zomming)
     **/
    ...
    private void initialize(Context context)
    {
        ...
        targetImage = context.getResources().getDrawable(R.drawable.new_student_centre);
    ...
    private class MyGestureListener extends GestureDetector.SimpleOnGestureListener
    {
        ...
        /**
         * Double tap feature is handled
         * * @param e: The event we will use to get the position of the image
         */
        @Override
        public boolean onDoubleTap(MotionEvent e) {
            ...
            /**
             * regulates to see if the first user touch is inside the image
             **/
            float left = xPosition;
            float top = yPosition;
            ...
            if(inside){
                if(zoomIn)
                {
                    scaleFactor = scaleFactor / 3.0f;
                    xPosition = (xPosition - x)/3f + x;
                    yPosition = (yPosition - y)/3f + y;}
                else
                {
                    scaleFactor = scaleFactor * 3.0f;
                    xPosition = (xPosition - x)*3f + x;
                ...
                /**
                 * alternate the zoom value back to the orignal
                 **/
                zoomIn = !zoomIn;
            }
            return true;
